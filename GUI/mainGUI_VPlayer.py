...
class MainWindow(QtWidgets.QMainWindow, mainGUI.Ui_MainWindow):
    ...
    def __init__(self, video_file=''):
        ...
        self.VBoxCanvasLabel = Drawing(self.loadVidTab)
        self.VBoxCanvasLabel.lower()
        self.VBoxCanvasLabel.setGeometry(QRect(0, 0, 1024, 586))
        ...
        self.localModeButton.clicked.connect(self.selectLocalMode)
        self.liveModeButton.clicked.connect(self.selectLiveMode)
