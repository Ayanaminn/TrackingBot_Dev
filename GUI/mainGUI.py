...
"}")
        ...
        self.cntMaxSlider_5 = QtWidgets.QSlider(self.horizontalLayoutWidget_7)
        self.cntMaxSlider_5.setMinimum(2)
        self.cntMaxSlider_5.setMaximum(9999)
        self.cntMaxSlider_5.setSliderPosition(100)
        self.cntMaxSlider_5.setOrientation(QtCore.Qt.Horizontal)
        self.cntMaxSlider_5.setObjectName("cntMaxSlider_5")
        self.verticalLayout_8.addWidget(self.cntMaxSlider_5)
        self.cntMinSlider_5 = QtWidgets.QSlider(self.horizontalLayoutWidget_7)
        self.cntMinSlider_5.setMinimum(1)
        self.cntMinSlider_5.setMaximum(9998)
        self.cntMinSlider_5.setOrientation(QtCore.Qt.Horizontal)
        self.cntMinSlider_5.setObjectName("cntMinSlider_5")
        self.verticalLayout_8.addWidget(self.cntMinSlider_5)
        self.horizontalLayout_5.addLayout(self.verticalLayout_8)
        self.verticalLayout_9 = QtWidgets.QVBoxLayout()
        self.verticalLayout_9.setObjectName("verticalLayout_9")
        self.threTabText2_3 = QtWidgets.QLabel(self.horizontalLayoutWidget_7)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.threTabText2_3.sizePolicy().hasHeightForWidth())
        self.threTabText2_3.setSizePolicy(sizePolicy)
        self.threTabText2_3.setAlignment(QtCore.Qt.AlignCenter)
        self.threTabText2_3.setObjectName("threTabText2_3")
        self.verticalLayout_9.addWidget(self.threTabText2_3)
        self.cntMaxSpin_3 = QtWidgets.QSpinBox(self.horizontalLayoutWidget_7)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.cntMaxSpin_3.sizePolicy().hasHeightForWidth())
        self.cntMaxSpin_3.setSizePolicy(sizePolicy)
        self.cntMaxSpin_3.setMinimum(2)
        self.cntMaxSpin_3.setMaximum(9999)
        self.cntMaxSpin_3.setProperty("value", 100)
        self.cntMaxSpin_3.setObjectName("cntMaxSpin_3")
        self.verticalLayout_9.addWidget(self.cntMaxSpin_3)
        self.threTabText3_3 = QtWidgets.QLabel(self.horizontalLayoutWidget_7)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.threTabText3_3.sizePolicy().hasHeightForWidth())
        self.threTabText3_3.setSizePolicy(sizePolicy)
        self.threTabText3_3.setAlignment(QtCore.Qt.AlignCenter)
        self.threTabText3_3.setObjectName("threTabText3_3")
        self.verticalLayout_9.addWidget(self.threTabText3_3)
        self.cntMinSpin_3 = QtWidgets.QSpinBox(self.horizontalLayoutWidget_7)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.cntMinSpin_3.sizePolicy().hasHeightForWidth())
        self.cntMinSpin_3.setSizePolicy(sizePolicy)
        self.cntMinSpin_3.setMinimum(1)
        self.cntMinSpin_3.setMaximum(9998)
        self.cntMinSpin_3.setObjectName("cntMinSpin_3")
        self.verticalLayout_9.addWidget(self.cntMinSpin_3)
        self.horizontalLayout_5.addLayout(self.verticalLayout_9)
        self.threTabText4_3 = QtWidgets.QLabel(self.loadCamTab)
        self.threTabText4_3.setGeometry(QtCore.QRect(1020, 400, 81, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.resetThreButton_2 = QtWidgets.QPushButton(self.loadCamTab)
        self.resetThreButton_2.setGeometry(QtCore.QRect(1210, 540, 89, 39))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.resetThreButton_2.sizePolicy().hasHeightForWidth())
        self.resetThreButton_2.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.resetThreButton_2.setFont(font)
        self.resetThreButton_2.setObjectName("resetThreButton_2")
        self.applyThreButton_2 = QtWidgets.QPushButton(self.loadCamTab)
        self.applyThreButton_2.setGeometry(QtCore.QRect(1040, 540, 89, 39))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.applyThreButton_2.sizePolicy().hasHeightForWidth())
        self.applyThreButton_2.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.applyThreButton_2.setFont(font)
        self.applyThreButton_2.setObjectName("applyThreButton_2")
        self.threTabText8_2 = QtWidgets.QLabel(self.loadCamTab)
        self.threTabText8_2.setGeometry(QtCore.QRect(1030, 340, 121, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.threTabText8_2.setFont(font)
        self.threTabText8_2.setObjectName("threTabText8_2")
        self.blockSizeSlider_2 = QtWidgets.QSlider(self.loadCamTab)
        self.blockSizeSlider_2.setGeometry(QtCore.QRect(1030, 250, 211, 22))
        self.blockSizeSlider_2.setMinimum(1)
        self.blockSizeSlider_2.setMaximum(255)
        self.blockSizeSlider_2.setProperty("value", 11)
        self.blockSizeSlider_2.setOrientation(QtCore.Qt.Horizontal)
        self.blockSizeSlider_2.setObjectName("blockSizeSlider_2")
        self.blockSizeSpin_2 = QtWidgets.QSpinBox(self.loadCamTab)
        self.blockSizeSpin_2.setGeometry(QtCore.QRect(1250, 250, 51, 22))
        self.blockSizeSpin_2.setMinimum(1)
        self.blockSizeSpin_2.setMaximum(255)
        self.blockSizeSpin_2.setProperty("value", 11)
        self.blockSizeSpin_2.setObjectName("blockSizeSpin_2")
        self.threTabText5_2 = QtWidgets.QLabel(self.loadCamTab)
        self.threTabText5_2.setGeometry(QtCore.QRect(1020, 220, 71, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.threTabText5_2.setFont(font)
        self.threTabText5_2.setAlignment(QtCore.Qt.AlignCenter)
        self.threTabText5_2.setObjectName("threTabText5_2")
        self.offsetSlider_2 = QtWidgets.QSlider(self.loadCamTab)
        self.offsetSlider_2.setGeometry(QtCore.QRect(1030, 310, 211, 22))
        self.offsetSlider_2.setMinimum(1)
        self.offsetSlider_2.setMaximum(255)
        self.offsetSlider_2.setSliderPosition(11)
        self.offsetSlider_2.setOrientation(QtCore.Qt.Horizontal)
        self.offsetSlider_2.setObjectName("offsetSlider_2")
        self.offsetSpin_2 = QtWidgets.QSpinBox(self.loadCamTab)
        self.offsetSpin_2.setGeometry(QtCore.QRect(1250, 300, 51, 22))
        self.offsetSpin_2.setMinimum(1)
        self.offsetSpin_2.setMaximum(255)
        self.offsetSpin_2.setProperty("value", 11)
        self.offsetSpin_2.setObjectName("offsetSpin_2")
        self.threTabText6_2 = QtWidgets.QLabel(self.loadCamTab)
        self.threTabText6_2.setGeometry(QtCore.QRect(1020, 280, 51, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.threTabText6_2.setFont(font)
        self.threTabText6_2.setAlignment(QtCore.Qt.AlignCenter)
        self.threTabText6_2.setObjectName("threTabText6_2")
        ...
        self.threTabText11_2 = QtWidgets.QLabel(self.loadCamTab)
        self.threTabText11_2.setGeometry(QtCore.QRect(1030, 140, 121, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.threTabText11_2.setFont(font)
        self.threTabText11_2.setAlignment(QtCore.Qt.AlignCenter)
        self.threTabText11_2.setWordWrap(True)
        self.threTabText11_2.setObjectName("threTabText11_2")
        self.applyMaskcheckBox_2 = QtWidgets.QCheckBox(self.loadCamTab)
        self.applyMaskcheckBox_2.setGeometry(QtCore.QRect(1030, 100, 111, 17))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.applyMaskcheckBox_2.setFont(font)
        self.applyMaskcheckBox_2.setObjectName("applyMaskcheckBox_2")
        self.threTabText12_2 = QtWidgets.QLabel(self.loadCamTab)
        self.threTabText12_2.setGeometry(QtCore.QRect(1190, 140, 121, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.threTabText12_2.setFont(font)
        self.threTabText12_2.setAlignment(QtCore.Qt.AlignCenter)
        self.threTabText12_2.setWordWrap(True)
        self.threTabText12_2.setObjectName("threTabText12_2")
        self.horizontalLayoutWidget_8 = QtWidgets.QWidget(self.loadCamTab)
        self.horizontalLayoutWidget_8.setGeometry(QtCore.QRect(1030, 50, 261, 31))
        ...
        self.threTabText1_3 = QtWidgets.QLabel(self.horizontalLayoutWidget_8)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.threTabText1_3.setFont(font)
        self.threTabText1_3.setAlignment(QtCore.Qt.AlignCenter)
        self.threTabText1_3.setObjectName("threTabText1_3")
        self.horizontalLayout_6.addWidget(self.threTabText1_3)
        self.objNumBox_3 = QtWidgets.QSpinBox(self.horizontalLayoutWidget_8)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.objNumBox_3.sizePolicy().hasHeightForWidth())
        self.objNumBox_3.setSizePolicy(sizePolicy)
        self.objNumBox_3.setSuffix("")
        self.objNumBox_3.setMinimum(1)
        self.objNumBox_3.setObjectName("objNumBox_3")
        self.horizontalLayout_6.addWidget(self.objNumBox_3)
        self.threTabText10_2 = QtWidgets.QLabel(self.loadCamTab)
        self.threTabText10_2.setGeometry(QtCore.QRect(1190, 120, 121, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.threTabText10_2.setFont(font)
        self.threTabText10_2.setWordWrap(True)
        self.threTabText10_2.setObjectName("threTabText10_2")
        self.threTabText9_2 = QtWidgets.QLabel(self.loadCamTab)
        self.threTabText9_2.setGeometry(QtCore.QRect(1030, 120, 121, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.threTabText9_2.setFont(font)
        self.threTabText9_2.setWordWrap(True)
        self.threTabText9_2.setObjectName("threTabText9_2")
        self.horizontalLayoutWidget_9 = QtWidgets.QWidget(self.loadCamTab)
        self.horizontalLayoutWidget_9.setGeometry(QtCore.QRect(0, 590, 231, 41))
        ...
        self.previewBoxLabel_2 = QtWidgets.QLabel(self.loadCamTab)
        self.previewBoxLabel_2.setGeometry(QtCore.QRect(704, 396, 320, 180))
        self.previewBoxLabel_2.setFrameShape(QtWidgets.QFrame.Box)
        self.previewBoxLabel_2.setObjectName("previewBoxLabel_2")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.threTabText2_3.setText(_translate("MainWindow", "Max"))
        self.threTabText3_3.setText(_translate("MainWindow", "Min"))
        self.threTabText4_3.setText(_translate("MainWindow", "Object size"))
        self.resetThreButton_2.setText(_translate("MainWindow", "Reset"))
        self.applyThreButton_2.setText(_translate("MainWindow", "Apply"))
        self.threTabText8_2.setText(_translate("MainWindow", "Threshold preview"))
        self.threTabText5_2.setText(_translate("MainWindow", "Block size"))
        self.threTabText6_2.setText(_translate("MainWindow", "Offset"))
        self.threTabText7_2.setText(_translate("MainWindow", "Detection settings"))
        self.threTabText11_2.setText(_translate("MainWindow", "(Darker object)"))
        self.applyMaskcheckBox_2.setText(_translate("MainWindow", "Apply mask"))
        self.threTabText12_2.setText(_translate("MainWindow", "(Brighter object)"))
        self.threTabText1_3.setText(_translate("MainWindow", "Number of objects"))
        self.threTabText10_2.setText(_translate("MainWindow", "Darker background"))
        self.threTabText9_2.setText(_translate("MainWindow", "Brighter background"))
        ...
        self.previewBoxLabel_2.setText(_translate("MainWindow", "preview"))
