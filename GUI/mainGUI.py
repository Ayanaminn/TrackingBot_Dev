...
"}")
        ...
        self.localModeButton.setGeometry(QtCore.QRect(240, 230, 91, 41))
        self.localModeButton.setObjectName("localModeButton")
        self.liveModeButton = QtWidgets.QPushButton(self.menuTab)
        self.liveModeButton.setGeometry(QtCore.QRect(510, 230, 91, 41))
        ...
        self.endVideo = QtWidgets.QPushButton(self.loadVidTab)
        self.endVideo.setGeometry(QtCore.QRect(1060, 610, 75, 23))
        ...
        self.loadImgButton.setGeometry(QtCore.QRect(1150, 600, 71, 31))
        ...
        self.fileNameLabel = QtWidgets.QLabel(self.loadVidTab)
        self.fileNameLabel.setGeometry(QtCore.QRect(1040, 10, 61, 51))
        self.fileNameLabel.setObjectName("fileNameLabel")
        self.label_2 = QtWidgets.QLabel(self.loadVidTab)
        self.label_2.setGeometry(QtCore.QRect(1040, 70, 121, 41))
        self.label_2.setObjectName("label_2")
        self.fileNameLabel_2 = QtWidgets.QLabel(self.loadVidTab)
        self.fileNameLabel_2.setGeometry(QtCore.QRect(1040, 110, 61, 51))
        self.fileNameLabel_2.setObjectName("fileNameLabel_2")
        self.fileNameLabel_3 = QtWidgets.QLabel(self.loadVidTab)
        self.fileNameLabel_3.setGeometry(QtCore.QRect(1040, 160, 61, 51))
        self.fileNameLabel_3.setObjectName("fileNameLabel_3")
        self.reloadVidButton = QtWidgets.QPushButton(self.loadVidTab)
        self.reloadVidButton.setEnabled(False)
        self.reloadVidButton.setGeometry(QtCore.QRect(1220, 20, 75, 23))
        self.reloadVidButton.setObjectName("reloadVidButton")
        self.VBoxCanvasLabel = QtWidgets.QLabel(self.loadVidTab)
        self.VBoxCanvasLabel.setGeometry(QtCore.QRect(0, 0, 1024, 576))
        self.VBoxCanvasLabel.setFrameShape(QtWidgets.QFrame.Box)
        self.VBoxCanvasLabel.setObjectName("VBoxCanvasLabel")
        ...
        self.VBoxLabel.raise_()
        self.endVideo.raise_()
        self.loadVidButton.raise_()
        self.loadImgButton.raise_()
        self.horizontalLayoutWidget.raise_()
        self.fileNameLabel.raise_()
        self.label_2.raise_()
        self.fileNameLabel_2.raise_()
        self.fileNameLabel_3.raise_()
        self.reloadVidButton.raise_()
        self.caliTabLinkButton.raise_()
        ...
        self.caliNumInput = QtWidgets.QLineEdit(self.caliTab)
        self.caliNumInput.setEnabled(False)
        self.caliNumInput.setGeometry(QtCore.QRect(1170, 80, 91, 31))
        self.caliNumInput.setInputMask("")
        self.caliNumInput.setClearButtonEnabled(False)
        self.caliNumInput.setObjectName("caliNumInput")
        ...
        self.horizontalSlider = QtWidgets.QSlider(self.threTab)
        self.horizontalSlider.setGeometry(QtCore.QRect(1030, 120, 211, 22))
        self.horizontalSlider.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider.setObjectName("horizontalSlider")
        self.spinBox = QtWidgets.QSpinBox(self.threTab)
        self.spinBox.setGeometry(QtCore.QRect(1250, 120, 51, 22))
        self.spinBox.setObjectName("spinBox")
        self.horizontalSlider_2 = QtWidgets.QSlider(self.threTab)
        self.horizontalSlider_2.setGeometry(QtCore.QRect(1030, 180, 211, 22))
        self.horizontalSlider_2.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider_2.setObjectName("horizontalSlider_2")
        self.spinBox_2 = QtWidgets.QSpinBox(self.threTab)
        self.spinBox_2.setGeometry(QtCore.QRect(1250, 170, 51, 22))
        ...
        self.threPlayButton.setEnabled(False)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.threStopButton.setEnabled(False)
        ...
        self.vidProgressBar_2 = QtWidgets.QSlider(self.horizontalLayoutWidget_5)
        self.vidProgressBar_2.setEnabled(False)
        self.vidProgressBar_2.setMaximumSize(QtCore.QSize(900, 16777215))
        self.vidProgressBar_2.setOrientation(QtCore.Qt.Horizontal)
        self.vidProgressBar_2.setObjectName("vidProgressBar_2")
        self.threSliderLayout.addWidget(self.vidProgressBar_2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "Video length (hh:mm:ss)"))
        self.fileNameLabel_2.setText(_translate("MainWindow", "Frame rate"))
        self.fileNameLabel_3.setText(_translate("MainWindow", "Resolution"))
        self.reloadVidButton.setText(_translate("MainWindow", "Select File"))
        self.VBoxCanvasLabel.setText(_translate("MainWindow", "Canvas"))
